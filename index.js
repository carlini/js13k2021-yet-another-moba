...
//const shared = fs.existsSync('./public/shared.js') ? fs.readFileSync('./public/shared.js', 'utf8') : ''; // TODO RESTORE
const shared = fs.readFileSync('./public/utils.js', 'utf8') + fs.readFileSync('./public/game.js', 'utf8') + fs.readFileSync('./public/graphics.js', 'utf8')
...
app.set('port', (process.env.PORT || 8080)) // TODO REVERT
    .set('storage', process.env.DATABASE_URL || 'sqlite::memory:') // TODO REVERT
